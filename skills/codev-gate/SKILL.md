...
Decision gate must be exactly identical to Current gate for an active gate. Gate identity is case-sensitive; never reuse or normalize an approval from a different gate identifier.
